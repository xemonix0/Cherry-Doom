...
default_t nughud_defaults[] = {
  ...
  WIDGET_X(   "nughud_armoricon_x",   nughud.armoricon,        0              ),
  WIDGET_Y(   "nughud_armoricon_y",   nughud.armoricon,        0              ),
  WIDGET_W(   "nughud_armoricon_wide",nughud.armoricon,        0              ),
  ...
  TEXTLINE_Y( "nughud_fps_y",         nughud.fps,              24             ),
  ...
  TEXTLINE_A( "nughud_secret_align",  nughud.secret,           0              ),
