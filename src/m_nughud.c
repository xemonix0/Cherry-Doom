...
default_t nughud_defaults[] = {
  { "nughud_ammo_x",        (config_t *)&nughud.ammo.x,           NULL, {ST_AMMOX},       {-1,319}, number },
  { "nughud_ammo_y",        (config_t *)&nughud.ammo.y,           NULL, {ST_AMMOY},       {0,199},  number },
  { "nughud_ammo_wide",     (config_t *)&nughud.ammo.wide,        NULL, {-1},             {-1,1},   number },
  { "nughud_health_x",      (config_t *)&nughud.health.x,         NULL, {ST_HEALTHX},     {-1,319}, number },
  { "nughud_health_y",      (config_t *)&nughud.health.y,         NULL, {ST_HEALTHY},     {0,199},  number },
  { "nughud_health_wide",   (config_t *)&nughud.health.wide,      NULL, {-1},             {-1,1},   number },
  { "nughud_arms2_x",       (config_t *)&nughud.arms[0].x,        NULL, {111},            {-1,319}, number },
  { "nughud_arms2_y",       (config_t *)&nughud.arms[0].y,        NULL, {172},            {0,199},  number },
  { "nughud_arms2_wide",    (config_t *)&nughud.arms[0].wide,     NULL, {-1},             {-1,1},   number },
  { "nughud_arms3_x",       (config_t *)&nughud.arms[1].x,        NULL, {119},            {-1,319}, number },
  { "nughud_arms3_y",       (config_t *)&nughud.arms[1].y,        NULL, {172},            {0,199},  number },
  { "nughud_arms3_wide",    (config_t *)&nughud.arms[1].wide,     NULL, {-1},             {-1,1},   number },
  { "nughud_arms4_x",       (config_t *)&nughud.arms[2].x,        NULL, {127},            {-1,319}, number },
  { "nughud_arms4_y",       (config_t *)&nughud.arms[2].y,        NULL, {172},            {0,199},  number },
  { "nughud_arms4_wide",    (config_t *)&nughud.arms[2].wide,     NULL, {-1},             {-1,1},   number },
  { "nughud_arms5_x",       (config_t *)&nughud.arms[3].x,        NULL, {135},            {-1,319}, number },
  { "nughud_arms5_y",       (config_t *)&nughud.arms[3].y,        NULL, {172},            {0,199},  number },
  { "nughud_arms5_wide",    (config_t *)&nughud.arms[3].wide,     NULL, {-1},             {-1,1},   number },
  { "nughud_arms6_x",       (config_t *)&nughud.arms[4].x,        NULL, {111},            {-1,319}, number },
  { "nughud_arms6_y",       (config_t *)&nughud.arms[4].y,        NULL, {182},            {0,199},  number },
  { "nughud_arms6_wide",    (config_t *)&nughud.arms[4].wide,     NULL, {-1},             {-1,1},   number },
  { "nughud_arms7_x",       (config_t *)&nughud.arms[5].x,        NULL, {119},            {-1,319}, number },
  { "nughud_arms7_y",       (config_t *)&nughud.arms[5].y,        NULL, {182},            {0,199},  number },
  { "nughud_arms7_wide",    (config_t *)&nughud.arms[5].wide,     NULL, {-1},             {-1,1},   number },
  { "nughud_arms8_x",       (config_t *)&nughud.arms[6].x,        NULL, {127},            {-1,319}, number },
  { "nughud_arms8_y",       (config_t *)&nughud.arms[6].y,        NULL, {182},            {0,199},  number },
  { "nughud_arms8_wide",    (config_t *)&nughud.arms[6].wide,     NULL, {-1},             {-1,1},   number },
  { "nughud_arms9_x",       (config_t *)&nughud.arms[7].x,        NULL, {135},            {-1,319}, number },
  { "nughud_arms9_y",       (config_t *)&nughud.arms[7].y,        NULL, {182},            {0,199},  number },
  { "nughud_arms9_wide",    (config_t *)&nughud.arms[7].wide,     NULL, {-1},             {-1,1},   number },
  { "nughud_frags_x",       (config_t *)&nughud.frags.x,          NULL, {174},            {-1,319}, number },
  { "nughud_frags_y",       (config_t *)&nughud.frags.y,          NULL, {171},            {0,199},  number },
  { "nughud_frags_wide",    (config_t *)&nughud.frags.wide,       NULL, {0},              {-1,1},   number },
  { "nughud_face_x",        (config_t *)&nughud.face.x,           NULL, {-1},             {-1,319}, number },
  { "nughud_face_y",        (config_t *)&nughud.face.y,           NULL, {ST_FACESY},      {0,199},  number },
  { "nughud_face_wide",     (config_t *)&nughud.face.wide,        NULL, {0},              {-1,1},   number },
  { "nughud_face_bg",       (config_t *)&nughud.face_bg,          NULL, {1},              {0,1},    number },
  { "nughud_armor_x",       (config_t *)&nughud.armor.x,          NULL, {ST_ARMORX},      {-1,319}, number },
  { "nughud_armor_y",       (config_t *)&nughud.armor.y,          NULL, {ST_ARMORY},      {0,199},  number },
  { "nughud_armor_wide",    (config_t *)&nughud.armor.wide,       NULL, {1},              {-1,1},   number },
  { "nughud_key0_x",        (config_t *)&nughud.keys[0].x,        NULL, {ST_KEY0X},       {-1,319}, number },
  { "nughud_key0_y",        (config_t *)&nughud.keys[0].y,        NULL, {ST_KEY0Y},       {0,199},  number },
  { "nughud_key0_wide",     (config_t *)&nughud.keys[0].wide,     NULL, {1},              {-1,1},   number },
  { "nughud_key1_x",        (config_t *)&nughud.keys[1].x,        NULL, {ST_KEY1X},       {-1,319}, number },
  { "nughud_key1_y",        (config_t *)&nughud.keys[1].y,        NULL, {ST_KEY1Y},       {0,199},  number },
  { "nughud_key1_wide",     (config_t *)&nughud.keys[1].wide,     NULL, {1},              {-1,1},   number },
  { "nughud_key2_x",        (config_t *)&nughud.keys[2].x,        NULL, {ST_KEY2X},       {-1,319}, number },
  { "nughud_key2_y",        (config_t *)&nughud.keys[2].y,        NULL, {ST_KEY2Y},       {0,199},  number },
  { "nughud_key2_wide",     (config_t *)&nughud.keys[2].wide,     NULL, {1},              {-1,1},   number },
  { "nughud_ammo0_x",       (config_t *)&nughud.ammos[0].x,       NULL, {ST_AMMO0X},      {-1,319}, number },
  { "nughud_ammo0_y",       (config_t *)&nughud.ammos[0].y,       NULL, {ST_AMMO0Y},      {0,199},  number },
  { "nughud_ammo0_wide",    (config_t *)&nughud.ammos[0].wide,    NULL, {1},              {-1,1},   number },
  { "nughud_ammo1_x",       (config_t *)&nughud.ammos[1].x,       NULL, {ST_AMMO1X},      {-1,319}, number },
  { "nughud_ammo1_y",       (config_t *)&nughud.ammos[1].y,       NULL, {ST_AMMO1Y},      {0,199},  number },
  { "nughud_ammo1_wide",    (config_t *)&nughud.ammos[1].wide,    NULL, {1},              {-1,1},   number },
  { "nughud_ammo2_x",       (config_t *)&nughud.ammos[2].x,       NULL, {ST_AMMO2X},      {-1,319}, number },
  { "nughud_ammo2_y",       (config_t *)&nughud.ammos[2].y,       NULL, {ST_AMMO2Y},      {0,199},  number },
  { "nughud_ammo2_wide",    (config_t *)&nughud.ammos[2].wide,    NULL, {1},              {-1,1},   number },
  { "nughud_ammo3_x",       (config_t *)&nughud.ammos[3].x,       NULL, {ST_AMMO3X},      {-1,319}, number },
  { "nughud_ammo3_y",       (config_t *)&nughud.ammos[3].y,       NULL, {ST_AMMO3Y},      {0,199},  number },
  { "nughud_ammo3_wide",    (config_t *)&nughud.ammos[3].wide,    NULL, {1},              {-1,1},   number },
  { "nughud_maxammo0_x",    (config_t *)&nughud.maxammos[0].x,    NULL, {ST_MAXAMMO0X},   {-1,319}, number },
  { "nughud_maxammo0_y",    (config_t *)&nughud.maxammos[0].y,    NULL, {ST_MAXAMMO0Y},   {0,199},  number },
  { "nughud_maxammo0_wide", (config_t *)&nughud.maxammos[0].wide, NULL, {1},              {-1,1},   number },
  { "nughud_maxammo1_x",    (config_t *)&nughud.maxammos[1].x,    NULL, {ST_MAXAMMO1X},   {-1,319}, number },
  { "nughud_maxammo1_y",    (config_t *)&nughud.maxammos[1].y,    NULL, {ST_MAXAMMO1Y},   {0,199},  number },
  { "nughud_maxammo1_wide", (config_t *)&nughud.maxammos[1].wide, NULL, {1},              {-1,1},   number },
  { "nughud_maxammo2_x",    (config_t *)&nughud.maxammos[2].x,    NULL, {ST_MAXAMMO2X},   {-1,319}, number },
  { "nughud_maxammo2_y",    (config_t *)&nughud.maxammos[2].y,    NULL, {ST_MAXAMMO2Y},   {0,199},  number },
  { "nughud_maxammo2_wide", (config_t *)&nughud.maxammos[2].wide, NULL, {1},              {-1,1},   number },
  { "nughud_maxammo3_x",    (config_t *)&nughud.maxammos[3].x,    NULL, {ST_MAXAMMO3X},   {-1,319}, number },
  ...
  { "nughud_time_y",        (config_t *)&nughud.time.y,           NULL, {151},            {0,199},  number },
  ...
  { "nughud_sts_y",         (config_t *)&nughud.sts.y,            NULL, {159},            {0,199},  number },
  { "nughud_sts_wide",      (config_t *)&nughud.sts.wide,         NULL, {-1},             {-1,1},   number },
  { "nughud_title_x",       (config_t *)&nughud.title.x,          NULL, {-1},             {0,319},  number },
  { "nughud_title_y",       (config_t *)&nughud.title.y,          NULL, {143},            {0,199},  number },
  { "nughud_title_wide",    (config_t *)&nughud.title.wide,       NULL, {-1},             {-1,1},   number },
  { "nughud_coord_x",       (config_t *)&nughud.coord.x,          NULL, {-1},             {0,319},  number },
  { "nughud_coord_y",       (config_t *)&nughud.coord.y,          NULL, {0},              {0,199},  number },
  { "nughud_coord_wide",    (config_t *)&nughud.coord.wide,       NULL, {1},              {-1,1},   number },
  { "nughud_fps_x",         (config_t *)&nughud.fps.x,            NULL, {-1},             {0,319},  number },
  { "nughud_fps_y",         (config_t *)&nughud.fps.y,            NULL, {8},              {0,199},  number },
  { "nughud_fps_wide",      (config_t *)&nughud.fps.wide,         NULL, {1},              {-1,1},   number },
  ...
  { "nughud_patch2_x",      (config_t *)&nughud.patches[1].x,     NULL, {0},              {0,319},  number },
  { "nughud_patch2_y",      (config_t *)&nughud.patches[1].y,     NULL, {0},              {0,199},  number },
  ...
  { "nughud_patch3_x",      (config_t *)&nughud.patches[2].x,     NULL, {0},              {0,319},  number },
  { "nughud_patch3_y",      (config_t *)&nughud.patches[2].y,     NULL, {0},              {0,199},  number },
  ...
  { "nughud_patch4_x",      (config_t *)&nughud.patches[3].x,     NULL, {0},              {0,319},  number },
  { "nughud_patch4_y",      (config_t *)&nughud.patches[3].y,     NULL, {0},              {0,199},  number },
  ...
  { "nughud_patch5_x",      (config_t *)&nughud.patches[4].x,     NULL, {0},              {0,319},  number },
  { "nughud_patch5_y",      (config_t *)&nughud.patches[4].y,     NULL, {0},              {0,199},  number },
  ...
  { "nughud_patch6_x",      (config_t *)&nughud.patches[5].x,     NULL, {0},              {0,319},  number },
  { "nughud_patch6_y",      (config_t *)&nughud.patches[5].y,     NULL, {0},              {0,199},  number },
  ...
  { "nughud_patch7_x",      (config_t *)&nughud.patches[6].x,     NULL, {0},              {0,319},  number },
  { "nughud_patch7_y",      (config_t *)&nughud.patches[6].y,     NULL, {0},              {0,199},  number },
  ...
  { "nughud_patch8_x",      (config_t *)&nughud.patches[7].x,     NULL, {0},              {0,319},  number },
  { "nughud_patch8_y",      (config_t *)&nughud.patches[7].y,     NULL, {0},              {0,199},  number },
  ...
  { "nughud_weapheight",    (config_t *)&nughud.weapheight,       NULL, {0},              {0,199},  number },
