...
default_t nughud_defaults[] = {
  ...
  { "nughud_frags_x",       (config_t *)&nughud.frags.x,          NULL, {ST_FRAGSX},      {-1,320}, number },
  { "nughud_frags_y",       (config_t *)&nughud.frags.y,          NULL, {ST_FRAGSY},      {0,200},  number },
  { "nughud_frags_wide",    (config_t *)&nughud.frags.wide,       NULL, {-1},             {-1,1},   number },
