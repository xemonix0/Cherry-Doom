...
default_t nughud_defaults[] = {
  ...
  { "nughud_face_bg",       (config_t *)&nughud.face.misc,        NULL, {1},              {0,1},    number, ss_none, wad_yes },
  ...
  { "nughud_time_x",        (config_t *)&nughud.time.x,           NULL, {0},              {0,320},  number, ss_none, wad_yes },
  { "nughud_time_y",        (config_t *)&nughud.time.y,           NULL, {ST_Y-2*HU_GAPY}, {0,200},  number, ss_none, wad_yes },
  { "nughud_time_wide",     (config_t *)&nughud.time.wide,        NULL, {-1},             {-1,1},   number, ss_none, wad_yes },
  { "nughud_time_sts",      (config_t *)&nughud.time.misc,        NULL, {1},              {0,1},    number, ss_none, wad_yes },
  { "nughud_sts_x",         (config_t *)&nughud.sts.x,            NULL, {0},              {0,320},  number, ss_none, wad_yes },
  { "nughud_sts_y",         (config_t *)&nughud.sts.y,            NULL, {ST_Y-HU_GAPY},   {0,200},  number, ss_none, wad_yes },
  { "nughud_sts_wide",      (config_t *)&nughud.sts.wide,         NULL, {-1},             {-1,1},   number, ss_none, wad_yes },
