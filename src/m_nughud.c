...
#define PATCHYMIN 0
#define PATCHYMAX 200

#define PATCH_X(n, m) { n, (config_t *)&(m).x,    NULL, { 0         }, { PATCHXMIN, PATCHXMAX }, number }
#define PATCH_Y(n, m) { n, (config_t *)&(m).y,    NULL, { 0         }, { PATCHYMIN, PATCHYMAX }, number }
#define PATCH_W(n, m) { n, (config_t *)&(m).wide, NULL, { 0         }, { -1,         1        }, number }
...
default_t nughud_defaults[] = {
  ...
  WIDGET_X( "nughud_arms2_x",       nughud.arms[0],          111            ),
  WIDGET_Y( "nughud_arms2_y",       nughud.arms[0],          172            ),
  WIDGET_W( "nughud_arms2_wide",    nughud.arms[0],          -1             ),
  WIDGET_X( "nughud_arms3_x",       nughud.arms[1],          119            ),
  WIDGET_Y( "nughud_arms3_y",       nughud.arms[1],          172            ),
  WIDGET_W( "nughud_arms3_wide",    nughud.arms[1],          -1             ),
  WIDGET_X( "nughud_arms4_x",       nughud.arms[2],          127            ),
  WIDGET_Y( "nughud_arms4_y",       nughud.arms[2],          172            ),
  WIDGET_W( "nughud_arms4_wide",    nughud.arms[2],          -1             ),
  WIDGET_X( "nughud_arms5_x",       nughud.arms[3],          135            ),
  WIDGET_Y( "nughud_arms5_y",       nughud.arms[3],          172            ),
  WIDGET_W( "nughud_arms5_wide",    nughud.arms[3],          -1             ),
  WIDGET_X( "nughud_arms6_x",       nughud.arms[4],          111            ),
  WIDGET_Y( "nughud_arms6_y",       nughud.arms[4],          182            ),
  WIDGET_W( "nughud_arms6_wide",    nughud.arms[4],          -1             ),
  WIDGET_X( "nughud_arms7_x",       nughud.arms[5],          119            ),
  WIDGET_Y( "nughud_arms7_y",       nughud.arms[5],          182            ),
  WIDGET_W( "nughud_arms7_wide",    nughud.arms[5],          -1             ),
  WIDGET_X( "nughud_arms8_x",       nughud.arms[6],          127            ),
  WIDGET_Y( "nughud_arms8_y",       nughud.arms[6],          182            ),
  WIDGET_W( "nughud_arms8_wide",    nughud.arms[6],          -1             ),
  WIDGET_X( "nughud_arms9_x",       nughud.arms[7],          135            ),
  WIDGET_Y( "nughud_arms9_y",       nughud.arms[7],          182            ),
  WIDGET_W( "nughud_arms9_wide",    nughud.arms[7],          -1             ),
  ...
  WIDGET_T( "nughud_face_bg",       nughud.face_bg,          1              ),
