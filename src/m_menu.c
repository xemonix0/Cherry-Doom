...
setup_menu_t comp_settings5[] =  // [Nugget]
{
  {"Nugget - Cosmetic", S_SKIP|S_TITLE, m_null, C_X, M_Y + comp5_title1 * COMP_SPC},
    ...
    {"Manually-toggled moving doors are silent",     S_YESNO|S_STRICT|S_COSMETIC, m_null, C_X, M_Y + comp5_manualdoor   * COMP_SPC, {"comp_manualdoor"}},
    ...
    {"Higher god-mode face priority",                S_YESNO|S_STRICT|S_COSMETIC, m_null, C_X, M_Y + comp5_godface      * COMP_SPC, {"comp_godface"}},
