...
#  endif
...

  {
    ...
    {STATSFORMAT_RATIO}, {0,NUMSTATSFORMATS-1}, number, ss_none, wad_no,
    "level stats format in Level Table (0 = match HUD, 1 = ratio, 2 = boolean, 3 = percentage, 4 = remaining, 5 = count)"
  },
