...
This file contains the full list of changes for every version of Cherry Doom. Changes in the upcoming release are listed in the [Unreleased](#unreleased) section of this changelog.

## Unreleased

This version is up to date with [_Nugget Doom 5.1.0_](https://github.com/MrAlaux/Nugget-Doom/releases/tag/nugget-doom-5.1.0) and [_Woof! 15.3.0_](https://github.com/fabiangreffrath/woof/releases/tag/woof_15.3.0).
